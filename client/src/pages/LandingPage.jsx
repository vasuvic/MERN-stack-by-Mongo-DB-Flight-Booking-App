    ...
    <div className="landingPage">
      <div className="landingHero">
        <div className="landingHero-title">
          <h1 className="banner-h1">Your best flight booking companion is here....</h1>
        ...
        {Flights.length > 0 && (
          <div className="availableFlightsContainer">
            ...
            <div className="Flights">
              {Flights.filter(Flight => (checkBox ? (Flight.origin === departure && Flight.destination === destination) || (Flight.origin === destination && Flight.destination === departure) : (Flight.origin === departure && Flight.destination === destination))).map((Flight) => (
      ...
      <section id="about" className="section-about p-4">
        <div className="container">
          ...
          <p className="section-description">
            Welcome to our Flight ticket booking app, where we are dedicated to providing you with an exceptional travel experience from start to finish.
          </p>
          <p className="section-description">
            We understand the importance of convenience and efficiency in your travel plans. Our user-friendly interface allows you to effortlessly browse through a wide range of Flight schedules, compare fares, and choose the perfect travel option that suits your needs.
          </p>
        </div>
      </section>
    </div>
